...
<body bgcolor="#ffffff" onContextmenu="return false"
	...
	<div id="wrap">
		<div class="container">
			...
			<h3>Purpose</h3>
			<p>
				絶対音感ならぬ絶対色感を身に付ける。 <a href="http://abpro.jp">ABPro2014</a> での発表作品です。
			<p>
				<br>
			<h3>Problem</h3>
			<p>
			...
			<p>同じ名前が入力された場合は、以前より記録が良い場合のみ反映されます。</p>
			<br>
			<h3>Attention</h3>
			<p>
			...
			<h3>Contact</h3>
			<p>
				Author: <a href="http://twitter.com/lanevok/">lanevok</a> (<a
					href="http://lanevok.com/">web</a>)
			</p>
			<br>
			<br> <br>
		</div>
